...
- 当前仓库：<https://github.com/soniccat-design/soniccat-case-radar>
- 公开页面：<https://soniccat-design.github.io/soniccat-case-radar/>
...
1. 打开仓库 <https://github.com/soniccat-design/soniccat-case-radar>。
2. 打开仓库 `Settings`。
3. 进入 `Pages`。
...
部署成功后的公开地址是 <https://soniccat-design.github.io/soniccat-case-radar/>。
...
1. 进入 GitHub 仓库。
2. 打开 `Actions`。
3. 选择 `Daily Professional Shoe Cases`。
4. 点击 `Run workflow`。
5. 选择 `main`，保持 `force_publish = true`。
6. 点击 `Run workflow`。
